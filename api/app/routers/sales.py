...
@router.get("/monthly-trend", response_model=APIResponse, summary="Monthly Sales Trend")
async def get_monthly_sales(
    limit: int = Query(default=12, ge=1, le=60, description="Number of recent months to return"),
):
    try:
        data = db_service.execute_query(
...
@router.get("/yoy-growth", response_model=APIResponse, summary="Year-over-Year Growth")
